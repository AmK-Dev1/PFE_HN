                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    <img src="{{asset('/images/Alfred_bleu_tête.png')}}" height="100px" alt="">
<!--
                                    <h1 class="brand-text text-primary ml-1"> {{trans_choice('labels.models.office',2)}}</h1>
-->
                                </a>
                                ...
                                <form class="auth-login-form mt-2" action="{{route('user.login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="{{--{{route('office.forgot.password.email')}}--}}">
                                                <small>{{__('messages.static.forgot_password')}}</small>
                                            </a>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle @error('password') is-invalid @enderror">
                                            <input type="password" autocomplete="current-password" class="form-control form-control-merge @error('password') error @enderror" id="login-password" name="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
