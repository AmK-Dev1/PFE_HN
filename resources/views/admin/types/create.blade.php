                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('admin.types.index')}}"> {{__('messages.static.list',['name'=> trans_choice('labels.models.type',2)])}}</a>
                                    </li>
                        ...
                        <div class="card">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{route('admin.types.store')}}">
                                            @csrf
                                            <div class="row">
