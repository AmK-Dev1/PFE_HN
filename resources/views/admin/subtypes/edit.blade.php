                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a
                                            href="{{ route('admin.subtypes.index') }}"> {{__('messages.static.list',['name'=> trans_choice('labels.models.subtype',2)])}}</a>
                                    </li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post"
                                            action="{{ route('admin.subtypes.update', $subtype->id) }}">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                <div class="col-md-6 col-12 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('name', $subtype->name) }}" required />
                                                        @error('name')
                                                ...
                                                <div class="col-md-6 col-12 mb2">
                                                    <div class="form-group">
                                                        <label for="type_id">Type</label>
                                                        <select name="type_id" class="form-control" required>
                                                            @foreach($types as $type)
                                                                <option value="{{ $type->id }}" {{ $subtype->type_id == $type->id ? 'selected' : '' }}>
                                                                    {{ $type->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
