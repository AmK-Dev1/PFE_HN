...
return [
    ...
    'attributes' => [
        'plan_actions.*.number_of_occurrences' => 'Fréquence',
        'plan_actions.*.cns_code' => 'Code CNS',
        'prescription.content' => 'Type d\'ordonnance',
        'prescriber_provider_code' => 'Code médecin',
        'establishment_date' => 'Date d\'établissement',
        'plan_actions.*.body_parts' => 'Partie du corp'
    ],
];
